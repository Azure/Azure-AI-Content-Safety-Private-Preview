...
The Ungroundedness (Hallucination) Detection API detects ungroundedness generated by the large language models (LLMs). Ungroundedness refers to instances where the LLMs produces information that is non-factual or inaccurate from what was present in the source materials provided by the users.
...
- **Speed vs Interpretability**:
  ...
  > - Reasoning mode: Offers a detailed explanation for detected ungrounded segments, easy for understanding.
