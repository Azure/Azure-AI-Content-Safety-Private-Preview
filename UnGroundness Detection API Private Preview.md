...
##  🗃Key Features
- Customizable Domains: Allows users to specify the domain (like medical, generic, etc.) for more tailored detection based on the field’s specific needs.
...
## 💡 QuickStart - Ungroundedness Detection API 
...
| **ungroundedPercentage** | The percentage of the text considered ungrounded. The percentage will range from 0 to 1.| Float	 |
