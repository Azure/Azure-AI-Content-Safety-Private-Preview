...
The Hallucination (Ungroundedness) Detection API identifies instances of ungrounded information generated by GPT models or other large language models. Ungroundedness refers to situations where the model produces false or fictional information that does not align with user-provided information and context. 
