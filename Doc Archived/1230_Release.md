...
The API provides severity levels for four different categories, described below. For a comprehensive view of the category and severity levels definitions please refer to: [Categories and Severity Levels Guidelines](./Guidelines.md).
